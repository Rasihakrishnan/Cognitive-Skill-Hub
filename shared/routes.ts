...
export type QuestionResponse = z.infer<
  (typeof api.questions.create.responses)[201]
>;
export type ResultResponse = z.infer<
  (typeof api.results.create.responses)[201]
>;
